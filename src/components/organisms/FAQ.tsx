      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Trusted by Procurement Leaders</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {successStories.map((story, index) => (
              <motion.div
                ...
                className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border border-gray-100 relative overflow-hidden"
              >
                <div className="relative z-10 flex flex-col gap-4">
                  <FaQuoteLeft className="text-blue-100 mb-6 h-8 w-8" />
                  <blockquote className="text-gray-700 text-[15px]  h-[200px] relative z-10">
                    &quot;{story.quote}&quot;
                  </blockquote>
                  
                  <div className="flex items-center gap-4">
                    <div className="relative w-16 h-16 rounded-full overflow-hidden bg-gray-100 border-2 border-blue-100">
                      <Image
                        src={story.image}
                        alt={story.name}
                        fill
                ...
                <div className="absolute top-0 right-0 w-32 h-32 -mr-8 -mt-8 bg-blue-50 rounded-full opacity-70"></div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <motion.div
              ...
              className="mb-12"
            >
              <span className="block text-blue-600 font-medium mb-2">FAQ</span>
            ...
            <div className="space-y-6">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <span className={`font-semibold ${openIndex === index ? 'text-blue-700' : 'text-gray-900'}`}>
                      {faq.question}
                    </span>
                    <motion.div
            ...
            <div className="sticky top-24 space-y-8">
              <div className="relative rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-8">
                  <h3 className="text-2xl font-bold text-white mb-3">Global Procurement Network</h3>
                  <p className="text-white/90 mb-4">Join thousands of procurement professionals worldwide who trust simpliP2P</p>
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a
                    href="#contact"
                    className="bg-blue-50 hover:bg-blue-100 transition-colors text-blue-600 font-medium py-3 px-4 rounded-lg text-center"
                  >
                    Contact Us
                  </a>
                  <a
                    href="#demo"
                    className="bg-blue-600 hover:bg-blue-700 transition-colors text-white font-medium py-3 px-4 rounded-lg text-center"
                  >
                    Request Demo
                  </a>
                </div>
