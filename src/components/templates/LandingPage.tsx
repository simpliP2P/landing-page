...
export default function LandingPage(): JSX.Element {
  ...
  const handleGetStarted = (): void => {
    // Fix URL - remove the extra leading slash
  ...
  const featureItems: FeatureItem[] = [
    ...
    {
      icon: <FaShieldAlt className="h-8 w-8 text-amber-600" />,
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className="lg:w-1/2">
                  ...
                  >
                    <button
                      ...
                      className="bg-primary hover:bg-secondary text-white px-10 py-3 flex justify-center items-center rounded-lg text-lg font-semibold transition-colors"
                    >
                      <span className="text-[14px]">Get Started</span> 
                    </button>
                    <button
                      onClick={handleHowItWorks}
                      className="bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white border border-white/30 px-10 py-3 flex justify-center items-center rounded-lg text-lg font-semibold transition-all"
                    >
                      <span className="text-[14px]">How It Works</span> 
                    </button>
                  </motion.div>
                  ...
                  >
                    {[
                      ...
                      <div key={index} className="flex items-center gap-1.5 text-sm text-slate-300">
                ...
                >
                  ...
                  {/* Floating badges */}
                  <div className="absolute -top-4 -right-4 bg-gradient-to-br from-blue-600 to-blue-800 text-white text-xs py-1 px-3 rounded-full shadow-lg">
                    Enterprise Ready
                  </div>
                  <div className="absolute -bottom-3 -left-3 bg-gradient-to-br from-amber-500 to-amber-700 text-white text-xs py-1 px-3 rounded-full shadow-lg">
                    Cost-Effective
                  </div>
                </motion.div>
              </div>
          ...
          <section className="bg-white py-24">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16 max-w-3xl mx-auto">
                <h2 className="text-4xl font-bold text-gray-900 mb-6">Transform Your Procurement Operations</h2>
              ...
              <div className="grid md:grid-cols-3 gap-12">
                {featureItems.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="text-[#808080] font-medium text-[17px] leading-6">{feature.description}</p>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-12">
                  {stepItems.map((item, index) => (
                    <motion.div
                      ...
                      className="bg-white p-4 w-[70%] rounded-2xl shadow-lg hover:shadow-xl transition-all border-l-4 border-primary"
                    >
                      <div className="inline-block px-3 py-1 rounded-full bg-secondary text-primary text-lg font-bold mb-4">{item.step}</div>
                ...
                >
                  ...
                  <div className="absolute -top-8 -right-8 bg-white shadow-xl rounded-2xl p-6 max-w-xs">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <h2 className="text-4xl font-bold text-white mb-4">Ready to Transform Your Procurement Process?</h2>
                  ...
                  <form onSubmit={handleSubmitForm} className="grid grid-cols-2 gap-6">
                    <div className="col-span-2 md:col-span-1">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-slate-400"
                    ...
                    <div className="col-span-2">
                      <Button
                        ...
                        className={`w-full ${isSubmitting ? 'bg-blue-700' : 'bg-primary hover:bg-blue-600'} flex justify-center items-center text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors shadow-lg shadow-blue-500/30`}
                      >
