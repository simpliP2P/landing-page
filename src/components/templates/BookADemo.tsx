      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8 md:gap-12 relative z-10">
        ...
        <div className="w-full md:w-5/12 text-left">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">
            Optimize Your P2P Process with Our Solution
          </h2>
          <p className="text-lg text-slate-300 mb-8">
            Experience how our platform can revolutionize your procurement
            workflow, reduce cycle times, and drive significant cost savings for
            your organization. Our end-to-end solution transforms how your
            business handles purchasing, from requisition to payment.
          </p>
          ...
          <div className="relative h-64 md:h-96 rounded-xl overflow-hidden mb-6">
            ...
            <div className="absolute bottom-4 left-4 right-4 text-white">
              <p className="text-sm md:text-base font-medium">
                Advanced analytics dashboard for complete procurement visibility
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-7/12">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl shadow-2xl p-5 sm:p-8 border border-white/20">
            ...
            <p className="text-slate-300 mb-6">
              See how our solution addresses your specific procurement
              challenges
            </p>
              ...
              {state.message === "success" && (
                <div className="col-span-2 flex items-center space-x-2 text-green-400 bg-green-500/10 p-3 rounded-lg">
                  ...
                  <p aria-live="polite" className="text-base not-sr-only">
                    Thank you! Your demo request has been received. Our
                    procurement specialists will contact you within 24 hours to
                    schedule.
                  </p>
                </div>
              )}
