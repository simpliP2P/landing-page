...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary text-white pt-12 md:pt-20 pb-6 md:pb-10">
      <div className="container mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 mb-10 md:mb-12">
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-2 mb-4 md:mb-6">
              <Logo className="h-8 md:h-10 w-auto" theme="white" />
              <span className="text-xl text-white md:text-2xl font-bold">
                simpliP2P
              </span>
            </div>
            <p className="text-slate-300 mb-6 md:mb-8 text-xs md:text-sm">
              Streamlining procurement processes with intelligent automation,
              centralized data management, and real-time analytics.
            </p>
            <div className="flex items-center gap-3 md:gap-4">
              <a
                href="https://www.linkedin.com/company/simplip2p"
                className="bg-white/10 hover:bg-white/20 p-2 md:p-2.5 rounded-full transition-all"
              >
                <FaLinkedin className="w-3 h-3 md:w-4 md:h-4" />
              </a>
              <a
                href="https://www.instagram.com/simplip2p"
                className="bg-white/10 hover:bg-white/20 p-2 md:p-2.5 rounded-full transition-all"
              >
          ...
          <div className="col-span-1">
            <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-6 border-b border-white/10 pb-2">
              Solutions
            </h3>
            ...
            <ul className="space-y-3 md:space-y-4">
              ...
              >
                ...
                <span className="text-slate-300 text-xs md:text-sm leading-tight">
                  10 Agboola Aina Street, Off Toyin Street, Ikeja, Lagos,
                  Nigeria
                </span>
              </motion.li>
              <motion.li
              ...
              >
                ...
                <a
                  href="mailto:info@simplip2p.com"
